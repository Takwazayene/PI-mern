...
function Chart(props) {
    ...
    useEffect(() => {
      axios.get('http://localhost:5000/claim/countDelay').then(response => {
          setCountDelay( response.data)

      })

      axios.get('http://localhost:5000/claim/countNR').then(response => {
        setCountNR( response.data)

    })
    axios.get('http://localhost:5000/claim/countPBS').then(response => {
        setCountPBK( response.data)

    })
    axios.get('http://localhost:5000/claim/countOther').then(response => {
